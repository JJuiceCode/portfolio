...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative flex h-10 w-10 items-center justify-center rounded-full border border-[var(--border)] bg-[var(--surface)] text-[var(--foreground)] transition hover:border-violet-500/40 hover:text-violet-600 dark:hover:text-violet-400"
    >
      {!mounted ? (
