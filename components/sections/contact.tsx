    ...
    <section id="contact" className="scroll-mt-24 border-t border-border px-4 py-20 sm:px-6">
      <div className="mx-auto max-w-5xl">
        <div className="rounded-3xl border border-border bg-surface px-6 py-12 sm:px-10 sm:py-16">
          ...
          <a
            href="mailto:juk1126@gmail.com"
            className="group mt-8 inline-flex items-center gap-2 text-lg font-medium text-accent underline-offset-4 transition hover:underline"
          >
            juk1126@gmail.com
