      ...
      <div className="mx-auto grid max-w-5xl gap-12 md:grid-cols-[1fr_1.2fr] md:gap-16">
        ...
        <div className="space-y-4 text-[var(--muted)]">
          <p className="leading-relaxed">
            사용자가 직관적으로 이해할 수 있는 UI와, 유지보수하기 쉬운 코드
            구조를 목표로 합니다. Next.js, React, TypeScript를 주로 사용하며
            디자인 토큰과 컴포넌트 단위 설계를 선호합니다.
          </p>
          <p className="leading-relaxed">
            이 포트폴리오는 다크/라이트 테마와 반응형 레이아웃을 반영한 예시
            페이지입니다. 실제 프로필과 프로젝트 링크로 교체해 사용하세요.
          </p>
