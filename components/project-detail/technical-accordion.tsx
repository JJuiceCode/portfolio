    ...
    <section className="border-t border-border bg-surface/40 px-4 py-16 sm:px-6 sm:py-20">
      <div className="mx-auto max-w-6xl">
        <div className="max-w-2xl">
          <p className="text-xs font-medium uppercase tracking-[0.2em] text-accent">Technical deep-dive</p>
          <h2 className="mt-2 text-2xl font-semibold tracking-tight text-foreground sm:text-3xl">기술 상세</h2>
          <p className="mt-3 text-muted">영역을 선택하면 사용한 기술과 구체적인 구현·협업 내용을 확인할 수 있습니다.</p>
        </div>
              ...
              >
                <h3 className="m-0 text-base font-semibold">
                  <button
                    ...
                    className="flex w-full items-center justify-between gap-4 px-5 py-4 text-left text-foreground transition hover:bg-accent/5 focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-accent sm:px-6 sm:py-5 cursor-pointer"
                  >
                      ...
                      <div>
                        ...
                        <ul className="mt-3 flex flex-wrap gap-2">
                          {area.techStack.map(tech => (
                            <li key={tech} className="rounded-full border border-border bg-surface px-3 py-1 text-xs font-medium text-foreground">
                              {tech}
                            </li>
                          ))}
                        </ul>
                      ...
                      <div>
                        ...
                        <ul className="mt-3 space-y-3 text-sm leading-relaxed text-foreground">
                          {area.details.map((paragraph, i) => (
                            <li
                              key={i}
                              className="relative pl-4 before:absolute before:left-0 before:top-2 before:h-1.5 before:w-1.5 before:rounded-full before:bg-accent/80"
                            >
                              {paragraph}
                            </li>
                          ))}
