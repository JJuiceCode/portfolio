      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-muted">
            화면 단위로 역할을 나누어 기여했습니다. 아래 아코디언에서 각 영역의 기술 스택과 구현
            히스토리를 펼쳐 볼 수 있습니다.
          </p>
        </div>
        ...
        <ol className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {areas.map((area, index) => (
            <li key={area.id}>
              <div className="flex h-full flex-col rounded-2xl border border-border bg-surface p-5 shadow-sm transition hover:border-violet-500/35 hover:shadow-md hover:shadow-violet-500/5 dark:hover:shadow-violet-500/10">
